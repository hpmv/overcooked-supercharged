...
public interface ILogicalButton : ILogicalElement { bool IsDown(); void GetLogicTreeData(out AcyclicGraph<ILogicalElement,LogicalLinkInfo> g,out AcyclicGraph<ILogicalElement,LogicalLinkInfo>.Node n); }
...
public class PlayerControls { public GameObject gameObject;public T GetComponent<T>() where T:class=>gameObject.GetComponent<T>();public bool CanButtonBePressed()=>Application.isFocused; }
...
namespace Hpmv {
 public class InputData { public Dictionary<int,ChefInput> Input; }
