...
traced method.  This is a diagnostic parity fixture; the trace is read-only and
...
loader.STACK = (
    ("native-physics-trace", "NativePhysicsTrace-r8ag-mass-diagonalization-core-dev5", "trace"),
