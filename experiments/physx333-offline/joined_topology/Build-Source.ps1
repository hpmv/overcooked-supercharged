...
# The private source mirror is disposable; the pinned vendor tree and shared
# source build are read-only inputs throughout this experiment.
...
$compileEntry = '<ClCompile Include="..\..\SimulationController\src\JoinedTopologyBridge.cpp" />'
...
$force = '/INCLUDE:_oc2_physx333_joined_topology_recreate_v1'
