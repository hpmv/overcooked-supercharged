...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Build-Source.ps1" -Configuration release
...
if errorlevel 1 exit /b 1
"%CMAKE%" --build "%~dp0out-ninja" --config Release --target physx333_query_cross_swap_check
if errorlevel 1 exit /b 1
"%~dp0out-ninja\physx333_query_cross_swap_check.exe"
exit /b %errorlevel%
